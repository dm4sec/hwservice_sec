...
Java_com_huawei_startModelFromMem2Fuzzer_utils_ModelManager_registerListenerJNI(JNIEnv *env, jclass obj,
                                                          jobject callbacks) {
    env->GetJavaVM(&jvm);
...
Java_com_huawei_startModelFromMem2Fuzzer_utils_ModelManager_loadModelAsync(JNIEnv *env, jclass instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huawei_startModelFromMem2Fuzzer_utils_ModelManager_unloadModelAsync(JNIEnv *env, jclass instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huawei_startModelFromMem2Fuzzer_utils_ModelManager_loadModelFromFileAsync(JNIEnv *env, jclass type,
                                                             jstring modelName_,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huawei_startModelFromMem2Fuzzer_utils_ModelManager_loadModelAsyncFromBuffer(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huawei_startModelFromMem2Fuzzer_utils_ModelManager_runModelAsync(JNIEnv *env, jclass type,
