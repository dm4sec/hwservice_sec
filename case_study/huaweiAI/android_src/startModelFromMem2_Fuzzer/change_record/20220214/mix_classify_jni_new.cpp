...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_hiaidemo_utils_ModelManager_loadAndUnloadModelFromBufferSync(JNIEnv *env, jclass type) {
    HIAI_MixModelBuffer *modelBufferArray[] = {modelBuffer};
    int ret = HIAI_MixModel_LoadFromModelBuffers(manager, modelBufferArray, 1);
    LOGI("Java_com_huawei_hiaidemo_utils_ModelManager_loadAndUnloadModelFromBufferSync. HIAI_MixModel_LoadFromModelBuffers ret: %d ", ret);
    ret = HIAI_MixModel_UnLoadModel(manager);
    LOGI("Java_com_huawei_hiaidemo_utils_ModelManager_loadAndUnloadModelFromBufferSync. HIAI_MixModel_UnLoadModel ret: %d ", ret);
    return ret;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_hiaidemo_utils_ModelManager_prepareLoadBuffer(JNIEnv *env, jclass type,jstring modelname_,
