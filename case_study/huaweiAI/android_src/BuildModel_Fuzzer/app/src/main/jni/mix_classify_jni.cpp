...
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadModelSync(JNIEnv *env, jclass instance,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_unloadModelSync(JNIEnv *env, jclass instance) {
    if (NULL == manager) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadModelFromFileSync(JNIEnv *env, jclass type,jstring modelname_,
    ...
    LOGI("Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadModelFromFileSync. modelpath : %s ", modelpath);
    LOGI("Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadModelFromFileSync. modelname : %s ", modelname);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadModelSyncFromBuffer(JNIEnv *env, jclass type,
...
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_runModelSync(JNIEnv *env, jclass type, jobject modelInfo,
                                                             jobjectArray buf_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadAndUnloadModelFromBufferSync(JNIEnv *env, jclass type) {
    HIAI_MixModelBuffer *modelBufferArray[] = {modelBuffer};
    int ret = HIAI_MixModel_LoadFromModelBuffers(manager, modelBufferArray, 1);
    LOGI("Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadAndUnloadModelFromBufferSync. HIAI_MixModel_LoadFromModelBuffers ret: %d ", ret);
    ret = HIAI_MixModel_UnLoadModel(manager);
    LOGI("Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadAndUnloadModelFromBufferSync. HIAI_MixModel_UnLoadModel ret: %d ", ret);
    return ret;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_prepareLoadBuffer(JNIEnv *env, jclass type,jstring modelname_,
                                                              jstring modelpath_, jboolean ixMixModel) {
    const char *modelname = env->GetStringUTFChars(modelname_, 0);
    const char *modelpath = env->GetStringUTFChars(modelpath_, 0);
    LOGI("Java_com_huawei_BuildModelFuzzer_utils_ModelManager_loadModelFromFileSync. modelpath : %s ", modelpath);
