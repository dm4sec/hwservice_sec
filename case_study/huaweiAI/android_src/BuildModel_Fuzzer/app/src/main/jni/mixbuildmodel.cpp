...
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_modelCompatibilityProcessFromBuffer(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_huawei_BuildModelFuzzer_utils_ModelManager_modelCompatibilityProcessFromFile(JNIEnv *env, jclass type,
