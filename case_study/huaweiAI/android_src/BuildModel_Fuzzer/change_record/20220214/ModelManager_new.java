...
public class ModelManager {
    ...
    public static native int loadAndUnloadModelFromBufferSync();

    public static native int prepareLoadBuffer(String modelName,String modelpath,boolean isMixModel);
