...
Java.perform(function () {
    ...
    // helper func to locate the mData, mDataSize, mObjects, mObjectsSize or sth else.
    ...
    */
    ...
    var native_p = Module.getExportByName("libhidlbase.so", '_ZN7android8hardware10BpHwBinder8transactEjRKNS0_6ParcelEPS2_jNSt3__18functionIFvRS2_EEE');
    console.log("[i] BpHwBinder::transact addr: " + native_p)
